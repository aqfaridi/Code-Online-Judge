...
//    out.print(User);
   ...
   <%    
    ...
    try{
            ...
            String sql = "Select count(*) as col from " + contestcode+"submissions where problemid='"+problemid+"'";
            ...
            int start = id+1;
            int end = start + 19;
            String query="Select * from " + contestcode+"submissions where problemid='"+problemid+"' ORDER BY submittime DESC LIMIT "+id+","+end;
            //out.println(query);
  ...
  <%
            ...
            do{
               ...
               //  out.print("<tr class="+status+"><td><center>"+i+"</center></td><td><center><a href='solutionshow.jsp?id="+rs.getString("codefilename")+"&e="+rs.getString("ext")+"' >"+rs.getString("codefilename")+"</a></center> </td><td><center><a href='profile.jsp?uid="+rs.getString("username")+"' >"+rs.getString("username")+"</a></center> </td><td><center>"+rs.getString("submittime")+"</center></td><td><center>"+rs.getString("langdB")+"</center></td><td><center>"+ rs.getString("status")+"</center></td><td><center>"+rs.getString("timelimit")+"</center></td><td><center>"+rs.getString("memory")+" M</center></td></tr>");
                i++;
            }while(rs.next() && i<=end);
      ...
      for(int j=0;j<pages;j++)
          out.println("<li><a href='allsubmission.jsp?id="+(j*20)+"&c="+contestcode+"&q="+problemid+"'>"+(j+1)+"</a></li>");
