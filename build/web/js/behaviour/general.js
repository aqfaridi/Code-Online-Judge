var App = function () {
    ...
    if(command){
      ...
      function toggleSideBar(_this){
        ...
        if(w.hasClass("sb-collapsed")){
          $(".fa",b).addClass("icon icon-white icon-arrow-left").removeClass("icon icon-white icon-arrow-left");
          w.removeClass("sb-collapsed");
        }else{
          $(".fa",b).removeClass("icon icon-white icon-arrow-right").addClass("icon icon-white icon-arrow-right");
  ...
  return {
    ...
    init: function (options) {
      ...
      var offset = 220;
      var duration = 500;
      var button = $('<a href="#" class="back-to-top"><i class="icon icon-white icon-arrow-up"></i></a>');
