...
//    out.print(User);
   ...
   %>
        ...
        <ul class="nav nav-tabs nav-stacked"  style='background-color:white;'>
            <li>
                <a href="contestSet.jsp">Set Contest</a>
            </li>
            <li>
                <a href="contestsetter.jsp">Set Problem</a>
            </li>
            <li>
                <a href="#ChangePassword" data-toggle="tab">Change password</a>
            </li>
            <li>
                <a href="#comment" data-toggle="tab">Show comment</a>
            </li>
        </ul>
