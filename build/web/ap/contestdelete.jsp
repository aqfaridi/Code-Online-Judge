      ...
      <div class="col-sm-10 col-md-10">
         ...
         <%! public SessionFactory factory = null;%>
                  <% 
                       ...
                       String st = "FROM ContestInfo";
                       try
                       {
                           Query q =  s.createQuery(st);
                           List<ContestInfo> comments = q.list();
         ...
         {  
            ContestInfo tmp = (ContestInfo)ob[i-1];
            out.print("<tr><td><center>"+i+"</center></td><td><center><a href='problemshow.jsp?c="+tmp.getContestCode()+"' target= _blank>"+tmp.getContestCode()+"</a></center></td><td><center>"+tmp.getContestName()+" </center></td><td><center>"+tmp.getStartTime()+"</center> </td><td><center>"+tmp.getEndTime()+" </center></td><td><center>"+tmp.getNop()+"</center></td><td><a class='btn btn-danger' href = 'deleteaction.jsp?contest="+tmp.getContestCode()+"'>delete</a></td></tr>");
