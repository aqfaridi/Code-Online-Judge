...
//    out.print(User);
   ...
   %>
    ...
    try{
            ...
            String sql = "Select count(*) as col from " + contestcode+"submissions where problemid='"+problemid+"' and username='"+username+"'";
            ...
            int start = id+1;
            int end = start + 19;
            String query="Select * from " + contestcode+"submissions where username='"+username + "' and problemid='"+problemid+"' ORDER BY submittime DESC LIMIT "+id+","+end;
            //out.println(query);
  ...
  %>
                ...
                <tr style="font-weight:bold;">
                    <td colspan="8" style="background-color: #F4F4F4;"><h4><center><%=problemid%> &nbsp; &nbsp; Submissions</center></h4></td>
                </tr>
  ...
  <%
            ...
            do{
                ...
                if(status.equals("Accepted"))
                    ...
                    status = "danger";
                 out.print("<tr class="+status+"><td><center>"+i+"</center></td><td><center><a href='solutionshow.jsp?id="+rs.getString("codefilename")+"&e="+rs.getString("ext")+"&u="+rs.getString("username")+"&l="+rs.getString("langdB")+"&p="+rs.getString("problemid")+"&c="+rs.getString("contestid")+"' >"+rs.getString("codefilename")+"</a></center> </td><td><center><a href='profile.jsp?uid="+rs.getString("username")+"' >"+rs.getString("username")+"</a></center> </td><td><center>"+rs.getString("submittime")+"</center></td><td><center>"+rs.getString("langdB")+"</center></td><td><center>"+ rs.getString("status")+"</center></td><td><center>"+rs.getString("timelimit")+"</center></td><td><center>"+rs.getString("memory")+" M</center></td></tr>");
                i++;
            }while(rs.next() && i<=end);
      ...
      for(int j=0;j<pages;j++)
          out.println("<li><a href='mysubmission.jsp?id="+(j*20)+"&c="+contestcode+"&q="+problemid+"'>"+(j+1)+"</a></li>");
