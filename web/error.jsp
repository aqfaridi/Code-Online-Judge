<%-- 
    Document   : error
    Created on : 2 Jul, 2014, 11:53:02 PM
    Author     : letmestart
--%>
...
<div id="cl-wrapper" class="error-container">
	<div class="page-error">
		...
		<h3 class="text-center">Would you like to go <a href="index.jsp">home</a>?</h3>
	</div>
	<div class="text-center copy">&copy; 2014 <a href="#">Code Online Judge</a></div>
