                        ...
                        while(rs.next())
                        {
                            ...
                            do
                            {
                                ...
                                {    
                                    ...
                                    out.print("<a href='mysubmission.jsp?c="+contestcode+"&q="+problemcode+"&id=0'><b>"+ problemcode +"</b></a> &nbsp;&nbsp;&nbsp;");  
...
<option value="ZW">Zimbabwe</option>
 ...
 <td>                <textarea rows="3" name="address" class="col-sm-12" value="<% out.print(address); %>">  <%if(address!="")out.print(address);%> 
                           ...
                           <div class="form-group">
                    <label class="col-sm-3 control-label" for="inputEmail3">Default Language</label>
                    <div class="col-sm-9">
                          <select  id="language" name="dlang">
                               <%
         String dlang = now.getDlang();
     if(dlang=="")
         out.println("<option>- - Select default Language - -</option>");
     else
        out.println("<option>"+dlang+"</option>");
