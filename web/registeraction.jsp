            ...
            if(users.size() == 0)
              {
                    ...
                    User newUser = new User(username,password,name,email,true,"set your Institute name","set your Contact no","set your Address","Current city","country","website","aboutme","dd/mm/yyyy","127.0.0.1","profile.png",code,1000.0,0.0,"C++");
                    ...
                    try
                    {
                        ...
                        s.save(newUser);
                        t.commit(); 
                        qry = "insert into BEGINNERranking (userid) values('"+username+"')";
                        st.executeUpdate(qry);
                        qry = "insert into PRACTICEranking (userid) values('"+username+"')";
                        st2.executeUpdate(qry);
                    }
                    catch(Exception e){}
                    finally{factory.close(); s.close();con.close();}
