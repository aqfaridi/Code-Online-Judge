...
--%>
<%
String username1=(String)session.getAttribute("adminuser");
  ...
  <div id="head-nav" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><span>CodeOJ</span></a>
    ...
    <ul class="nav navbar-nav navbar-right user-nav">
      <li class="dropdown profile_menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="divider"></li>
          <li><a href="logoutadmin.jsp">Sign Out</a></li>
        </ul>
      </li>
    </ul>			
            ...
            <div class="nano nscroller">
              <div class="content">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <img src="images/avatar3_50.html" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Lucy</span> is now following you 
                    </a>
                  </li>
                </ul>
              </div>
