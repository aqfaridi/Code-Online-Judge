  ...
  <!-- Fixed navbar -->
   ...
   %>
		...
		<div class="container-fluid" id="pcont">
              ...
              <form action="problemSetaction.jsp" id="contact-form" class="form-horizontal" method="post">
          ...
          <div class="form-group">
            ...
            <label>Problem Code</label>
                <div class="input-group">
                        <span class="input-group-addon"><i class="icon-user"></i></span>
                        <input type="text" name="problemcode"   required data-parsley-minlength="6" placeholder="Problem Code" class="form-control">
                </div>
            <div id="nick-error"></div>
        </div>
        </div>
