    ...
    <div class="row" style="margin-top: 20px;">
      ...
      <div class="col-sm-10 col-md-10">
         ...
         {  
            ...
            out.print("<tr><td><center>"+tmp.getId()+"</center></td><td><center><a href='../profile.jsp?uid="+tmp.getUsername()+"' target= _blank>"+tmp.getUsername()+"</a></center></td><td><center>"+tmp.getValid()+" </center></td><td><center>"+tmp.getContestcode()+"</center> </td><td><center>"+tmp.getProblemcode()+" </center></td><td><center>"+tmp.getCommentProblem()+"</center></td><td><a class='btn btn-danger' href = 'deleteaction.jsp?cmt="+tmp.getId()+"'>delete</a></td></tr>");
