    ...
    <div class="row">
      <div class="col-sm-12 col-md-12">
         ...
         {  
            ...
            out.print("<tr><td>"+i+"</td><td><a href='../profile.jsp?uid="+tmp.getUsername()+"' target= _blank>"+tmp.getUsername()+"</a></td><td>"+tmp.getFullname()+" </td><td>"+tmp.getPhoneno()+" </td><td>"+tmp.getEmailid()+" </td><td>"+tmp.getInstitute()+"</td></tr>");
